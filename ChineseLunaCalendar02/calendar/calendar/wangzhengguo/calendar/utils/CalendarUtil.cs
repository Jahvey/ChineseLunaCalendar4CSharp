...
public  class CalendarUtil {
     ...
     * Gregorian历法实施年份
     */
    public static readonly int    GREGORIAN_FIRST_YEAR      = 1582;
    /**
     * Gregorian历法实施月份
     */
    public static readonly int    GREGORIAN_FIRST_MONTH     = 10;
    /**
     * Gregorian历法实施日期
     */
    public static readonly int    GREGORIAN_FIRST_DATE      = 15;

    /**
     * Julian历法废弃年份
     */
    public static readonly int    JULIAN_LAST_YEAR          = 1582;
    /**
     * Julian历法废弃月份
     */
    public static readonly int    JULIAN_LAST_MONTH         = 10;
    /**
     * Julian历法废弃日期
     */
    public static readonly int    JULIAN_LAST_DATE          = 4;

    /**
     * Gregorian历TT1582年10月15日中午12点的儒略日
     */
    private static readonly int   JULIAN_GREGORIAN_BOUNDARY = 2299161;

    /**
     * Gregorian历TT2000年1月1日中午12点的儒略日
     */
    public static readonly double J2000                     = 2451545.0d;

    /**
     * 1000年的日数
     */
    public static readonly double DAYS_OF_1000_YEARS        = 365250.0d;

    /**
     * 100年的日数
     */
    public static readonly double DAYS_OF_CENTURY           = 36525.0d;
     ...
     * @return 闰年返回true，平年返回false
     */
    public static bool isJulianLeapYear(int y) {
        return (y & 3) == 0;
    }
    ...
    private static DateTime fromJulianDateHelper(int a, double f, DateTimeKind tz) {
        int b = a + 1524;
        ...
        DateTime dateTime;
        dateTime = new DateTime(year, month, date, hour, minute, second, millisecond, tz);
     ...
     */
    public static DateTime fromJulianDateInGregorian(double jd, DateTimeKind tz) {
        int z = (int) (jd + 0.5);
        double f = jd + 0.5 - z;
     ...
     */
    public static DateTime fromJulianDateInJulian(double jd, DateTimeKind tz) {
        int z = (int) (jd + 0.5);
        double f = jd + 0.5 - z;
        int a = z;
        return fromJulianDateHelper(a, f, tz);
    ...
    public static DateTime fromJulianDate(double jd) {
        return fromJulianDate(jd, DateTimeKind.Local, true);
    }
     ...
     */
    public static DateTime fromJulianDate(double jd, DateTimeKind tz) {
     ...
     */
    public static DateTime fromJulianDate(double jd, bool tt2ut) {
        return fromJulianDate(jd, DateTimeKind.Local, tt2ut);
    }
     ...
     */
    public static DateTime fromJulianDate(double jd, DateTimeKind tz, bool tt2utc) {
        if (tt2utc) {
    ...
    public static double getDeltaT(double jd) {
        //要注意 这里的时间出现了 一些小幅度的变动
        DateTime cal = fromJulianDate(jd, DateTimeKind.Utc, false);
    ...
    public static void Main(string[] args) {
        ...
        foreach (var y in years ) {
            Console.WriteLine(y + ": " + isLeapYear(y));
        }
       Console.WriteLine(toJulianDate(2000, 1, 1));
       Console.WriteLine(toJulianDateInGregorian(2000, 1, 1));
       Console.WriteLine(toJulianDateInJulian(2000, 1, 1));
       Console.WriteLine(toJulianDate(1582, 10, 4));
       Console.WriteLine(toJulianDateInGregorian(1582, 10, 4));
       Console.WriteLine(toJulianDateInJulian(1582, 10, 4));
       Console.WriteLine(toJulianDate(1582, 10, 10));
       Console.WriteLine(toJulianDateInGregorian(1582, 10, 10));
       Console.WriteLine(toJulianDateInJulian(1582, 10, 10));
       Console.WriteLine(getWeekday(1582, 1, 1));
       Console.WriteLine(toJulianDate(2014, 8, 12, 0, 0, 0.0d));
       Console.WriteLine(toJulianDate(1599, 12, 29, 12, 0, 0.0d));
    }
}
